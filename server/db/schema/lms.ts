...
export const quizzes = sqliteTable("quizzes", {
  ...
  showCorrectAnswers: integer("show_correct_answers", { mode: "boolean" }).default(true).notNull(),
...
export const quizQuestions = sqliteTable("quiz_questions", {
  ...
  options: text("options", { mode: "json" }).$type<Array<{ id: string; text: string; isCorrect: boolean }>>().default([]),
...
export const quizAnswers = sqliteTable("quiz_answers", {
  ...
  answeredAt: integer("answered_at", { mode: "timestamp" }).$defaultFn(() => new Date()).notNull(),
}, (table) => [
...
export const assignments = sqliteTable("assignments", {
  ...
  allowLateSubmission: integer("allow_late_submission", { mode: "boolean" }).default(false).notNull(),
